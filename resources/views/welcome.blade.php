...
<body class="antialiased">
    <div
        class="relative flex items-top justify-center min-h-screen bg-blue-100 dark:bg-blue-900 sm:items-center py-4 sm:pt-0">
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                @auth
                    <button style="bg-color: red" class="btn btn-primary btn-sm">
                        <h3 style="color:Green"><b><strong><a href="{{ url('/dashboard') }}"
                                        class="text-sm text-blue-700 dark:text-blue-500 underline">Dashboard</a></strong></b>
                        </h3>
                    </button>
                @else
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow lg:rounded-lg">
                <div class="grid grid-cols md:grid-cols-25">
                    <header class="relative flex items-center justify-center h-screen mb-12 overflow-hidden">
                        <div class="relative z-30 p-5 text-2xl text-white bg-purple-300 bg-opacity-50 rounded-xl">
                            <!-- Your welcome button code -->
                            <div class=" flex items-end justify-center align-items-center">
                                <button type="button" btn-primary btn-lg
                                    class="button btn-bg-sky-500 btn-hover:bg-sky-700" data-layout="button-count"
                                    data-href="" data-action="button" data-show-faces="true" data-size="large"
                                    data-share="true">
                                    <a href="{{ route('dashboard') }}">
                                        <!--x-jet-application-mark class="block h-9 w-auto" /-->
                                        <b style="color:green;bg-sky-500 hover:bg-sky-700 ">click here -->></b>
                                    </a>
